...
class Parameters:
    ...
    @classmethod
    def from_list(cls, parameter_list: list[float | int | str | list[Any]]) -> Parameters:
...
def flatten_parameter_dict(parameter_dict: dict) -> Generator[tuple[str, list[Any], dict | None]]:
